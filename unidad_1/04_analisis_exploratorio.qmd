...
En el documento dedicado a [**tidyverse**](intro_tidyverse.qmd#gráficos-estadísticos-con-ggplot2) ya explicamos cómo funciona `ggplot2`. Aquí nos concentraremos únicamente en aplicar distintos elementos geométricos (`geoms`) para representar las variables según su tipo.
