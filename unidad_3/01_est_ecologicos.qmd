...
En este capítulo abordaremos a modo de introducción el [**modelo lineal general**](mod_estadistico.qmd), la [**covarianza y correlación,**](covarianza_correlacion.qmd) para luego entender los modelos de [**regresión lineal simple**](reg_lineal.qmd)**, [análisis de la varianza](anova.qmd)** y [**regresión lineal múltiple**](reg_lineal_multiple.qmd), ampliamente usados en el análisis de los estudios ecológicos, aunque no exclusivos de ellos.
