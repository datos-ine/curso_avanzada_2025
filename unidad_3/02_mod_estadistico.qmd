...
-   [**Regresión lineal simple**](reg_lineal.qmd): Examina la relación entre $Y$ y una variable independiente numérica.

-   [**Análisis de la varianza (ANOVA)**](anova.qmd): Evalúa las diferencias en la media de $Y$ respecto a los niveles de una variable categórica.

-   [**Regresión lineal múltiple**](reg_lineal_multiple.qmd): Explora la relación entre $Y$ y dos o más variables independientes, que pueden ser numéricas y/o categóricas.
