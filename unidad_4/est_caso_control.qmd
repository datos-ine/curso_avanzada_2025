...
El modelo multivariado a utilizar para estudios de casos y controles no apareados es la [**regresión logística**](reg_logistica.qmd), que desarrollaremos a continuación. Por otro lado, los estudios de CC apareados se analizan mediante modelos de [**regresión logística condicional**](reg_logistica_cond.qmd), los cuales abordaremos brevemente al final de la unidad.
