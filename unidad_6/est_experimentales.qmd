...
Una metodología frecuentemente utilizada es el [**análisis de supervivencia**](analisis_superv.qmd), donde el tiempo hasta la ocurrencia del evento cobra un rol central. Como ya se vio en la [unidad anterior](unidad_5/est_cohortes), esta técnica también puede aplicarse a estudios de cohortes. A continuación avanzaremos en su comprensión.
