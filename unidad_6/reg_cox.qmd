...
La **regresión de Cox** es la extensión multivariada del [**análisis de supervivencia**](analisis_superv.qmd) para evaluar de manera general variables dependientes del tipo "tiempo hasta un suceso o evento" y usa modelos de regresión, próximos al modelo de [**regresión logística**](unidad_4/reg_logistica). Es una técnica que permite identificar y evaluar la relación entre un conjunto de variables explicativas y la tasa de ocurrencia del suceso de interés.
