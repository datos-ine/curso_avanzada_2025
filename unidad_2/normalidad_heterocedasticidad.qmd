...
Este material es una continuación del capítulo sobre [Análisis exploratorio de datos](../unidad_1/analisis_exploratorio.qmd) de la **Unidad 1**. Recordemos que uno de los objetivos del EDA es conocer cómo se distribuyen los valores de las variables de interés.
