...
Como se mencionó en la [**sección anterior**](est_transversales.qmd), se requiere conocer algunos datos para el cálculo del tamaño de muestra requerido, entre los que destacan:
